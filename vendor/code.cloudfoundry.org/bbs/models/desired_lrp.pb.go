...
type DesiredLRP_UpdateStrategy int32

const (
	DesiredLRP_UpdateStrategyRolling  DesiredLRP_UpdateStrategy = 0
	DesiredLRP_UpdateStrategyRecreate DesiredLRP_UpdateStrategy = 1
)

var DesiredLRP_UpdateStrategy_name = map[int32]string{
	0: "ROLLING",
	1: "RECREATE",
}

var DesiredLRP_UpdateStrategy_value = map[string]int32{
	"ROLLING":  0,
	"RECREATE": 1,
}

func (DesiredLRP_UpdateStrategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f592e9299b63d68c, []int{6, 0}
}
...
type DesiredLRPRunInfo struct {
	...
	MetricTags                    map[string]*MetricTagValue `protobuf:"bytes,25,rep,name=metric_tags,json=metricTags,proto3" json:"metric_tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Deprecated: Do not use.
...
type DesiredLRPUpdate struct {
	...
	// Types that are valid to be assigned to OptionalImageUsername:
	//	*DesiredLRPUpdate_ImageUsername
	OptionalImageUsername isDesiredLRPUpdate_OptionalImageUsername `protobuf_oneof:"optional_image_username"`
	// Types that are valid to be assigned to OptionalImagePassword:
	//	*DesiredLRPUpdate_ImagePassword
	OptionalImagePassword isDesiredLRPUpdate_OptionalImagePassword `protobuf_oneof:"optional_image_password"`
}
...
type isDesiredLRPUpdate_OptionalImageUsername interface {
	isDesiredLRPUpdate_OptionalImageUsername()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
type isDesiredLRPUpdate_OptionalImagePassword interface {
...
type DesiredLRPUpdate_ImageUsername struct {
	ImageUsername string `protobuf:"bytes,5,opt,name=image_username,json=imageUsername,proto3,oneof" json:"image_username,omitempty"`
}
type DesiredLRPUpdate_ImagePassword struct {
	ImagePassword string `protobuf:"bytes,6,opt,name=image_password,json=imagePassword,proto3,oneof" json:"image_password,omitempty"`
}
...
func (*DesiredLRPUpdate_ImageUsername) isDesiredLRPUpdate_OptionalImageUsername() {}
func (*DesiredLRPUpdate_ImagePassword) isDesiredLRPUpdate_OptionalImagePassword() {}
...
func (m *DesiredLRPUpdate) GetOptionalImageUsername() isDesiredLRPUpdate_OptionalImageUsername {
	if m != nil {
		return m.OptionalImageUsername
	}
	return nil
}
func (m *DesiredLRPUpdate) GetOptionalImagePassword() isDesiredLRPUpdate_OptionalImagePassword {
	if m != nil {
		return m.OptionalImagePassword
	}
	return nil
}
...
func (m *DesiredLRPUpdate) GetImageUsername() string {
	if x, ok := m.GetOptionalImageUsername().(*DesiredLRPUpdate_ImageUsername); ok {
		return x.ImageUsername
	}
	return ""
}

func (m *DesiredLRPUpdate) GetImagePassword() string {
	if x, ok := m.GetOptionalImagePassword().(*DesiredLRPUpdate_ImagePassword); ok {
...
func (*DesiredLRPUpdate) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*DesiredLRPUpdate_ImageUsername)(nil),
		(*DesiredLRPUpdate_ImagePassword)(nil),
	}
}
...
type DesiredLRPResource struct {
	...
	// GPU resources requested. gpu_limit = 0 means no GPU required.
	// gpu_type is "nvidia", "amd", or "" (any type acceptable).
	GpuLimit   int32    `protobuf:"varint,5,opt,name=gpu_limit,json=gpuLimit,proto3" json:"gpu_limit,omitempty"`
	GpuType    string   `protobuf:"bytes,6,opt,name=gpu_type,json=gpuType,proto3" json:"gpu_type,omitempty"`
	GpuIndices []uint32 `protobuf:"varint,7,rep,packed,name=gpu_indices,json=gpuIndices,proto3" json:"gpu_indices,omitempty"`
}
...
func (m *DesiredLRPResource) GetGpuLimit() int32 {
	if m != nil {
		return m.GpuLimit
	}
	return 0
...
func (m *DesiredLRPResource) GetGpuType() string {
	if m != nil {
		return m.GpuType
	}
	return ""
...
func (m *DesiredLRPResource) GetGpuIndices() []uint32 {
	if m != nil {
		return m.GpuIndices
	}
	return nil
...
type DesiredLRP struct {
	...
	VolumeMountedFiles            []*File                    `protobuf:"bytes,38,rep,name=volume_mounted_files,json=volumeMountedFiles,proto3" json:"volume_mounted_files"`
	UpdateStrategy                DesiredLRP_UpdateStrategy  `protobuf:"varint,39,opt,name=update_strategy,json=updateStrategy,proto3,enum=models.DesiredLRP_UpdateStrategy" json:"update_strategy"`
	// GPU resources requested. Mirrors DesiredLRPResource's gpu_* fields.
	GpuLimit   int32    `protobuf:"varint,40,opt,name=gpu_limit,json=gpuLimit,proto3" json:"gpu_limit,omitempty"`
	GpuType    string   `protobuf:"bytes,41,opt,name=gpu_type,json=gpuType,proto3" json:"gpu_type,omitempty"`
	GpuIndices []uint32 `protobuf:"varint,42,rep,packed,name=gpu_indices,json=gpuIndices,proto3" json:"gpu_indices,omitempty"`
}
...
func (m *DesiredLRP) GetUpdateStrategy() DesiredLRP_UpdateStrategy {
	if m != nil {
		return m.UpdateStrategy
	}
	return DesiredLRP_UpdateStrategyRolling
}

func (m *DesiredLRP) GetGpuLimit() int32 {
	if m != nil {
		return m.GpuLimit
	}
	return 0
...
func (m *DesiredLRP) GetGpuType() string {
	if m != nil {
		return m.GpuType
	}
	return ""
...
func (m *DesiredLRP) GetGpuIndices() []uint32 {
	if m != nil {
		return m.GpuIndices
	}
	return nil
...
func init() {
	proto.RegisterEnum("models.DesiredLRP_UpdateStrategy", DesiredLRP_UpdateStrategy_name, DesiredLRP_UpdateStrategy_value)
...
var fileDescriptor_f592e9299b63d68c = []byte{
	...
	,
}

func (x DesiredLRP_UpdateStrategy) String() string {
	s, ok := DesiredLRP_UpdateStrategy_name[int32(x)]
	if ok {
		return s
	}
...
func (this *DesiredLRPUpdate) Equal(that interface{}) bool {
	...
	if that1.OptionalImageUsername == nil {
		if this.OptionalImageUsername != nil {
			return false
		}
	} else if this.OptionalImageUsername == nil {
		return false
	} else if !this.OptionalImageUsername.Equal(that1.OptionalImageUsername) {
		return false
	}
	if that1.OptionalImagePassword == nil {
		if this.OptionalImagePassword != nil {
			return false
		}
	} else if this.OptionalImagePassword == nil {
		return false
	} else if !this.OptionalImagePassword.Equal(that1.OptionalImagePassword) {
		return false
	}
	return true
}
...
func (this *DesiredLRPUpdate_ImageUsername) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*DesiredLRPUpdate_ImageUsername)
	if !ok {
		that2, ok := that.(DesiredLRPUpdate_ImageUsername)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *DesiredLRPUpdate_ImagePassword) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*DesiredLRPUpdate_ImagePassword)
	if !ok {
		that2, ok := that.(DesiredLRPUpdate_ImagePassword)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *DesiredLRPResource) Equal(that interface{}) bool {
	...
	if this.GpuLimit != that1.GpuLimit {
		return false
	}
	if this.GpuType != that1.GpuType {
		return false
	}
	if len(this.GpuIndices) != len(that1.GpuIndices) {
		return false
	}
	for i := range this.GpuIndices {
		if this.GpuIndices[i] != that1.GpuIndices[i] {
			return false
		}
	}
	return true
...
func (this *DesiredLRP) Equal(that interface{}) bool {
	...
	if this.UpdateStrategy != that1.UpdateStrategy {
		return false
	}
	if this.GpuLimit != that1.GpuLimit {
		return false
...
func (this *DesiredLRPUpdate) GoString() string {
	...
	if this.OptionalImageUsername != nil {
		s = append(s, "OptionalImageUsername: "+fmt.Sprintf("%#v", this.OptionalImageUsername)+",\n")
	}
	if this.OptionalImagePassword != nil {
		s = append(s, "OptionalImagePassword: "+fmt.Sprintf("%#v", this.OptionalImagePassword)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *DesiredLRPUpdate_ImageUsername) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&models.DesiredLRPUpdate_ImageUsername{` +
		`ImageUsername:` + fmt.Sprintf("%#v", this.ImageUsername) + `}`}, ", ")
	return s
}
func (this *DesiredLRPUpdate_ImagePassword) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&models.DesiredLRPUpdate_ImagePassword{` +
...
func (this *DesiredLRPResource) GoString() string {
	...
	s = append(s, "GpuLimit: "+fmt.Sprintf("%#v", this.GpuLimit)+",\n")
	s = append(s, "GpuType: "+fmt.Sprintf("%#v", this.GpuType)+",\n")
	s = append(s, "GpuIndices: "+fmt.Sprintf("%#v", this.GpuIndices)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *DesiredLRPUpdate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.OptionalImagePassword != nil {
		{
			size := m.OptionalImagePassword.Size()
			i -= size
			if _, err := m.OptionalImagePassword.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
	if m.OptionalImageUsername != nil {
		{
			size := m.OptionalImageUsername.Size()
			i -= size
			if _, err := m.OptionalImageUsername.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *DesiredLRPUpdate_ImageUsername) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DesiredLRPUpdate_ImageUsername) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.ImageUsername)
	copy(dAtA[i:], m.ImageUsername)
	i = encodeVarintDesiredLrp(dAtA, i, uint64(len(m.ImageUsername)))
...
func (m *DesiredLRPUpdate_ImagePassword) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DesiredLRPUpdate_ImagePassword) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.ImagePassword)
	copy(dAtA[i:], m.ImagePassword)
	i = encodeVarintDesiredLrp(dAtA, i, uint64(len(m.ImagePassword)))
...
func (m *DesiredLRPResource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.GpuIndices) > 0 {
		dAtA18 := make([]byte, len(m.GpuIndices)*10)
		var j17 int
		for _, num := range m.GpuIndices {
			for num >= 1<<7 {
		...
		i = encodeVarintDesiredLrp(dAtA, i, uint64(j17))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.GpuType) > 0 {
		...
		i = encodeVarintDesiredLrp(dAtA, i, uint64(len(m.GpuType)))
		i--
		dAtA[i] = 0x32
	}
	if m.GpuLimit != 0 {
		i = encodeVarintDesiredLrp(dAtA, i, uint64(m.GpuLimit))
		i--
		dAtA[i] = 0x28
	}
	if m.MaxPids != 0 {
...
func (m *DesiredLRP) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.GpuIndices) > 0 {
		dAtA20 := make([]byte, len(m.GpuIndices)*10)
		var j19 int
		for _, num := range m.GpuIndices {
			for num >= 1<<7 {
		...
		i = encodeVarintDesiredLrp(dAtA, i, uint64(j19))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xd2
	...
	if m.UpdateStrategy != 0 {
		i = encodeVarintDesiredLrp(dAtA, i, uint64(m.UpdateStrategy))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xb8
...
func (m *DesiredLRPUpdate) Size() (n int) {
	...
	if m.OptionalImageUsername != nil {
		n += m.OptionalImageUsername.Size()
	}
	if m.OptionalImagePassword != nil {
		n += m.OptionalImagePassword.Size()
	}
	return n
}
...
func (m *DesiredLRPUpdate_ImageUsername) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DesiredLRPUpdate_ImagePassword) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DesiredLRPResource) Size() (n int) {
	...
	if m.GpuLimit != 0 {
		n += 1 + sovDesiredLrp(uint64(m.GpuLimit))
	}
	l = len(m.GpuType)
	if l > 0 {
		n += 1 + l + sovDesiredLrp(uint64(l))
...
func (m *DesiredLRP) Size() (n int) {
	...
	if m.UpdateStrategy != 0 {
		n += 2 + sovDesiredLrp(uint64(m.UpdateStrategy))
	}
	if m.GpuLimit != 0 {
		n += 2 + sovDesiredLrp(uint64(m.GpuLimit))
	}
	l = len(m.GpuType)
	if l > 0 {
		n += 2 + l + sovDesiredLrp(uint64(l))
...
func (this *DesiredLRPUpdate) String() string {
	...
	s := strings.Join([]string{`&DesiredLRPUpdate{`,
		...
		`MetricTags:` + mapStringForMetricTags + `,`,
		`OptionalImageUsername:` + fmt.Sprintf("%v", this.OptionalImageUsername) + `,`,
		`OptionalImagePassword:` + fmt.Sprintf("%v", this.OptionalImagePassword) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *DesiredLRPUpdate_ImageUsername) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DesiredLRPUpdate_ImageUsername{`,
		`ImageUsername:` + fmt.Sprintf("%v", this.ImageUsername) + `,`,
		`}`,
	}, "")
	return s
}
func (this *DesiredLRPUpdate_ImagePassword) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DesiredLRPUpdate_ImagePassword{`,
		`ImagePassword:` + fmt.Sprintf("%v", this.ImagePassword) + `,`,
		`}`,
	}, "")
	return s
...
func (this *DesiredLRPResource) String() string {
	...
	s := strings.Join([]string{`&DesiredLRPResource{`,
		...
		`GpuLimit:` + fmt.Sprintf("%v", this.GpuLimit) + `,`,
		`GpuType:` + fmt.Sprintf("%v", this.GpuType) + `,`,
		`GpuIndices:` + fmt.Sprintf("%v", this.GpuIndices) + `,`,
		`}`,
	}, "")
	return s
}
func (this *DesiredLRP) String() string {
	...
	s := strings.Join([]string{`&DesiredLRP{`,
		...
		`LogRateLimit:` + strings.Replace(fmt.Sprintf("%v", this.LogRateLimit), "LogRateLimit", "LogRateLimit", 1) + `,`,
		`VolumeMountedFiles:` + repeatedStringForVolumeMountedFiles + `,`,
		`UpdateStrategy:` + fmt.Sprintf("%v", this.UpdateStrategy) + `,`,
		`GpuLimit:` + fmt.Sprintf("%v", this.GpuLimit) + `,`,
		`GpuType:` + fmt.Sprintf("%v", this.GpuType) + `,`,
		`GpuIndices:` + fmt.Sprintf("%v", this.GpuIndices) + `,`,
		`}`,
...
func (m *DesiredLRPUpdate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.OptionalImageUsername = &DesiredLRPUpdate_ImageUsername{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ImagePassword", wireType)
			...
			m.OptionalImagePassword = &DesiredLRPUpdate_ImagePassword{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDesiredLrp(dAtA[iNdEx:])
...
func (m *DesiredLRPResource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GpuLimit", wireType)
			}
			m.GpuLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 7:
			if wireType == 0 {
				...
				m.GpuIndices = append(m.GpuIndices, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.GpuIndices) == 0 {
					m.GpuIndices = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field GpuIndices", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipDesiredLrp(dAtA[iNdEx:])
	...
	for iNdEx < l {
		...
		case 39:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UpdateStrategy |= DesiredLRP_UpdateStrategy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
